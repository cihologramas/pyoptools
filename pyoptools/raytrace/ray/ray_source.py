...
def parallel_beam_p(origin=(0., 0., 0.), direction=(0., 0., 0), radius=0.5, num_rays=(5, 10), wavelength=0.58929, label=""):
    ...
    *label*
    ...
    ret_val = [Ray(pos=(0, 0, 0), dir=(0, 0, 1), wavelength=wavelength,
...
def point_source_c(origin=(0., 0., 0.), direction=(0., 0., 0), span=(pi/8, pi/8), num_rays=(10, 10), wavelength=0.58929, label=""):
...
def point_source_p(origin=(0., 0., 0.), direction=(0., 0., 0), span=pi/8, num_rays=(10, 10), wavelength=0.58929, label=""):
    ...
    *label*
    ...
    for r_ in range(1, nr):
        r = span*float(r_)/nr
        temp_ray = Ray(pos=(0, 0, 0), dir=(0, 0, 1), wavelength=wavelength,
